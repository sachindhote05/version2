    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1e3a8a] to-[#0f172a] pt-32 px-6 text-white">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          Not Just Offsites. Culture Transformation Experiences.
        ...
        <div className="bg-white/10 rounded-3xl shadow-xl shadow-slate-900/30 p-8 mb-12 border border-white/10 hover:shadow-2xl transition backdrop-blur">
          <p className="text-center text-slate-200 text-lg">
            We design strategic offsites that go beyond activities — creating alignment, trust, and lasting shifts in team dynamics and leadership.
          </p>
        </div>
    ...
    {[
      {
        ...
        desc: " •  Most offsites are engaging — but short-lived.\n •  Teams enjoy the experience. \nEnergy is high during the session. \nBut within weeks, everything goes back to normal.\n •  👉 Because offsites focus on activity, not transformation",
        color: "border-red-400",
      },
      {
        title: "Our Approach",
        desc: "• At Version2, offsites are designed as structured interventions.\n•  Experiential learning \n •  Psychological insights \n •  Identity and mindset work\n•  👉 So teams don’t just engage — they shift.  ",
        color: "border-blue-500",
      },
      {
        title: "What We Offer",
        desc: " • Trust-Building Offsites\n•  Culture Reset\n•  Leadership Alignment\n• Ethics Workshops",
  ...
  {[
    {
      ...
      desc: "Strengthens team dynamics by addressing underlying trust gaps and communication patterns.",
      icon: <FaUserTie />
    },
    {
      title: "Culture Reset & Alignment Interventions",
      desc: "Realigns teams with organizational values, vision, and expected behaviors.",
      icon: <FaBrain />
    },
    {
      title: "Leadership Alignment Workshops",
      desc: "Brings leadership teams onto a common page for strategy, communication, and execution.",
      icon: <FaCrown />
    }
  ].map((item, i) => (
      ...
      {[
        {
          title: "1. Diagnose",
          icon: <FaSearch />,
          desc: "We identify team dynamics, gaps, and underlying challenges"
        },
        {
          title: "Design",
          icon: <FaPenFancy />,
          desc: "We create a customized offsite experience aligned to your objectives"
        },
        {
          title: " Deliver",
          icon: <FaChalkboardTeacher />,
          desc: "We facilitate structured, experiential, and high-impact sessions"
        },
        {
          title: "Reinforce",
          icon: <FaSyncAlt />,
          desc: "We provide follow-up interventions to sustain outcomes"
        }
      ].map((step, i) => (
